/* 
This `generator.cpp` aims to find a Eden seed with Vanishing Twin, 1 red heart, low stats and no bombs. Its purpose is to find the worst seeds.
*/
#include<bits/stdc++.h>
#include"seedstr.hpp"
...
//		cout<<items.activeId<<" "<<items.passiveId<<" "<<items.card<<endl;
		...
		if(items.passiveId==697 && stats.hearts==2 &&
